...
<div class="slideshow-container">
    ...
    <div id="slide1" class="mySlides fade">
        ...
        <div class="textContainer">
            ...
            <h3 class="slidesDescription">As ChocoHolics Chocolate Factory, our mission is to make the world both bitter
                and sweeter one person at a time
...
<div class="description">
    ...
    <div>
        <p>
            A Dutch chemist by the name of Coenraad Van Houten was the one who discovered how to separate the cocoa
            liquor into cocoa powder and cocoa butter. On a side note, it was Coenraad Van Houten who also invented
            “Dutched Cocoa Powder,” which is made by treating the cocoa powder with alkaline salts. Whilst this improves
            the mixability for cooking baking purposes, it also washes out crucial nutrients found in cacao powder.
            <br><br>
            It wasn’t until many years later that the cocoa butter was mixed together with sugar and milk powder to
            create the first white chocolate bar. The same process is used today and thanks to craft chocolate makers,
            white chocolate is making a proud come back as a delicious fine food.
            <br><br>
            Some chocolate makers even have caramelised white or blonde bars on offer. These bars are made by heating
            the white chocolate mixture for longer than usual causing the sugar to caramelise and create a fudgy flavour
            and golden colour.
        </p>
    </div>
</div>
...
<div class="description">
    ...
    <div>
        <p>
            ...
            certain standard. The fermented beans are then dried and shipped to the chocolate maker who roasts them.
            After they’ve been roasted they are cracked and sorted.
            <br><br>
            The inside of the bean, also known as cocoa nibs, are separated from the shell, or husk. The nibs, along
            with the cocoa butter, are then ground and heated to create a thick chocolatey substance known as cocoa
            liquor.
            <br><br>
            If sugar is part of the recipe then it’s added towards the end of the mixing process. The chocolate is then
            cooled in a process also known as tempering before it’s poured into chocolate bar moulds. This process is
            the standard chocolate-making process and is also known as “bean to bar.”
        </p>
    </div>
...
<div class="description">
    ...
    <div>
        <p>
            A Swiss chemist and entrepreneur, Henri Nestlé, discovered how to produce powdered milk in 1867. Fast
            forward a few years and people started mixing the powdered milk together with the cocoa liquor during the
            bean to bar process. This method is still used by chocolate makers today.
        </p>
    </div>
